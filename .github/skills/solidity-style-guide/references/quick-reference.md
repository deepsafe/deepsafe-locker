...
One-page cheatsheet for agents. Full rules are in [../SKILL.md](../SKILL.md) and the upstream [README](https://github.com/Aboudjem/solidity-style-guide/blob/main/README.md).
